...
class BilibiliRepository {
  ...
  Future<AudioShow> resolveAsShow(SearchResult result) async {
  ...
  Future<AudioShow> loadCreatorShow(BilibiliCreatorShow show) async {
  ...
  AudioShow? _creatorShowFromDetail(
    Map<String, dynamic> detail,
    Episode episode,
  ) {
...
class BilibiliEpisodeContext {
  ...
  final AudioShow? collectionShow;
  final AudioShow? creatorShow;
}
